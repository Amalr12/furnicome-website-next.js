    ...
    return (
        <>
            <div className="bg-gray-100 p-20 rounded-lg shadow-md text-center" >
                ...
                <p className="mt-4 text-xl text-gray-400 text-center flex">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima, unde hic recusandae quas obcaecati reiciendis officiis ipsum dolor sit amet consectetur adipisicing elit. Minima, unde hic recusandae quas obcaecati reiciendis officiis</p>
      ...
      <Marquee  speed={50} gradient={false} className="flex flex-row items-center ">
        {partners.map((partner, index) => (
          <img
            ...
            src={partner.logo}
            alt={partner.name}
            className="h-12 w-auto my-10 mx-8 object-contain"
          />
        ))}
      </Marquee>
    </div>
