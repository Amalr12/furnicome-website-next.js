        ...
        <div className="flex flex-col bg-gray-300 p-5 md:p-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="bg-gray-200 rounded-xl p-4 md:p-5">
                    ...
                    <div className="grid  grid-cols-[1fr_4fr] gap-3 md:gap-4 mt-3 md:mt-4 p-3 md:p-5 bg-gray-200">
                        ...
                        <div>
                            ...
                            <h1 className="text-sm md:text-base">Paramekkav Oottupura 21/720, Thrissur,  Thrissur, Kerala - 680751</h1>
                        </div>
                    </div>
                    <div className="grid grid-cols-[1fr_4fr] gap-3 md:gap-4 mt-3 md:mt-4 p-3 md:p-5 bg-gray-200">
                        <div className="items-center justify-center flex">
                        ...
                        <div>
                            ...
                            <h1 className="text-sm md:text-base">9876543210</h1>
                        </div>
                    </div>
                    <div className="grid grid-cols-[1fr_4fr] gap-3 md:gap-4 mt-3 md:mt-4 p-3 md:p-5 bg-gray-200">
                        <div className="items-center justify-center flex">
                        ...
                        <div>
                            ...
                            <h1 className="text-sm md:text-base">abcwe@org.com</h1>
                        </div>
                    </div>
                    <div className="grid grid-cols-[1fr_4fr] gap-3 md:gap-4 mt-3 md:mt-4 p-3 md:p-5 bg-gray-200">
                        <div className="items-center justify-center flex">
                        ...
                        <div>
                            ...
                            <h1 className="text-sm md:text-base">Monday-Friday 10 AM-7 PM</h1>
                        </div>
                    </div>
                </div>
                <div className="bg-gray-200 rounded-xl p-4 md:p-5">
